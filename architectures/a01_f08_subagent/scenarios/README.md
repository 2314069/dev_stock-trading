...
| `s03_news_root_cause` | News Analyst プロンプト改修 (原因記事優先) | active | key_drivers から結果記事を排除し原因記事を選ばせる | **仮説完全確認**: key_drivers が結果記事 3/5 → 原因記事 5/5。direction/分布は s01 と同 (0.60 bearish)、**confidence +8** (62→70)。詳細は `runs/.../s03_news_root_cause/20260521T050000Z/summary.md` |
